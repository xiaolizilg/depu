...
namespace App\Models\Pusher\Traits\Attribute;

use Carbon\Carbon as Carbon;

/**
 * Class PusherAttribute.
 */
trait PusherAttribute
{
    ...
    public function getRoleDescAttribute()
    {
        ...
        switch ($this->attributes['role']) {
            case 0:
                $desc = '<span class="text-info"><i class="fa fa-users"></i> 全站用户</span>';
                break;
            case 1:
                $desc = '<span class="text-info"><i class="fa fa-apple"></i> IOS</span>';
                break;
            case 2:
                $desc = '<span class="text-info"><i class="fa fa-android"></i> 安卓</span>';
                break;
            case 3:
                $desc = '<span class="text-info"><i class="fa fa-group"></i> 用户组</span>';
                break;
            case 4:
                $desc = '<span class="text-info"><i class="fa fa-user"></i> 用户</span>';
                break;
        }
    ...
    public function getEventDescAttribute()
    {
        ...
        switch ($this->attributes['event']) {
            case 0:
                $desc = '<span class="text-info">无操作</span>';
                break;
            case 1:
                $desc = '<span class="text-info">外链跳转</span>';
                break;
            case 2:
                $desc = '<span class="text-info">应用跳转</span>';
                break;
        }
