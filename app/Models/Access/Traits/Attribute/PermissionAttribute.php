...
trait PermissionAttribute
{
     ...
     * @return string
     */
    public function getPermissionActionButtonsAttribute()
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.access.permission.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.access.permission.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.access.permission.edit').
            $this->getStatusButtonAttribute('backend.access.permission.mark').
            $this->getDeleteButtonAttribute('backend.access.permission.destroy');
    }
