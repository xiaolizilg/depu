...
trait CommentAttribute
{
    ...
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.comment.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.comment.forcedelete');
        }

        return
            $this->getReplyButtonAttribute('backend.comment.edit').
            $this->getStatusButtonAttribute('backend.comment.mark').
            $this->getDeleteButtonAttribute('backend.comment.destroy');
    }
