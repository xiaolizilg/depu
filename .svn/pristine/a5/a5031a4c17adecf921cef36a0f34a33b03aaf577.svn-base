...
namespace App\Models\Blogroll\Traits\Attribute;

use Carbon\Carbon as Carbon;

/**
 * Class BlogrollAttribute.
 */
trait BlogrollAttribute
{
    ...
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.content.blogroll.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.content.blogroll.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.content.blogroll.edit').
            $this->getDeleteButtonAttribute('backend.content.blogroll.destroy');
    }
