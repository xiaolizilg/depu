...
(function (global, factory) {
  ...
  Parsley.addMessages('zh', {
    defaultMessage: "该字段输入有误。",
    type: {
      email: "该字段必须是一个邮箱。",
      mobile: "该字段必须是一个手机号。",
      url: "该字段必须是一个URL地址。",
      number: "该字段必须是一个有效的数字。",
      integer: "该字段必须是一个有效的整数。",
      digits: "该字段必须是一个数字。",
      alphanum: "该字段必须是字母或数字。"
    },
    notblank: "该字段不应为空。",
    required: "该字段是必填的。",
    pattern: "该字段输入有误。",
    min: "该字段值应大于等于 %s.",
    max: "该字段值应小于等于 %s.",
    range: "该字段值应在 %s 和 %s 之间。",
    minlength: "该字段太短了，它应该有 %s 字符或更多。",
    maxlength: "该字段太长了，它应该有 %s 字符或更少。",
    length: "该字段长度错误。它应该介于 %s 和 %s 之间。",
    mincheck: "您至少必须选择 %s 个。",
    maxcheck: "您最多可以选择 %s 个。",
    check: "您只能在 %s 和 %s 之间选择。",
    equalto: "该字段值应该相等。"
  });
  ...
  Parsley.addMessages('en', {
    ...
    type: {
      ...
      mobile: "This value should be a valid mobile.",
