...
trait CountryAttribute
{
    ...
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.project.country.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.project.country.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.project.country.edit').
            $this->getDeleteButtonAttribute('backend.project.country.destroy');
    }
