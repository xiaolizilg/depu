    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.content.version.store') }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    <legend><h3 class="text-center">版本信息</h3></legend>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">版本名 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="title" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="版本名" data-parsley-required="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">版本号 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="code_id" data-parsley-trigger="change" data-parsley-required="true" data-parsley-type="integer" placeholder="版本号" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="url" data-parsley-trigger="change" data-parsley-maxlength="80" data-parsley-required="true" data-parsley-type="url"  placeholder="下载地址" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="input-group date">
                                <input type="text" name="app_updated_at" class="form-control" data-parsley-required="true" placeholder="年-月-日"/>
