...
trait NewsAttribute
{
    ...
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.content.news.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.content.news.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.content.news.edit').
            $this->getDeleteButtonAttribute('backend.content.news.destroy');
    }
