...
trait GroupAttribute
{
     ...
     * @return string
     */
    public function getGroupActionButtonsAttribute()
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.access.group.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.access.group.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.access.group.edit').
            $this->getStatusButtonAttribute('backend.access.group.mark').
            $this->getDeleteButtonAttribute('backend.access.group.destroy');
    }
