...
namespace App\Models\Tourism\Traits\Attribute;

use App\Models\Service\Service;
use Carbon\Carbon as Carbon;

/**
 * Class TourismAttribute.
 */
trait TourismAttribute
{
    ...
    {
        if ($this->trashed()) {
            return $this->getRestoreButtonAttribute('backend.hospital.tourism.restore').
                $this->getDeletePermanentlyButtonAttribute('backend.hospital.tourism.forcedelete');
        }

        return
            $this->getEditButtonAttribute('backend.hospital.tourism.edit').
            $this->getDeleteButtonAttribute('backend.hospital.tourism.destroy');
    }
