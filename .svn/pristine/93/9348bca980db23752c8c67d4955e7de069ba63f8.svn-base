    ...
    <div class="container" data-animation="true" data-animation-type="fadeInDown">
        ...
        <div class="row row-space-10">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-1.jpg') }}" alt="Work 1" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-3.jpg') }}" alt="Work 3" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-5.jpg') }}" alt="Work 5" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-7.jpg') }}" alt="Work 7" /></a>
                    </div>
                    <div class="desc">
        ...
        <div class="row row-space-10">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-2.jpg') }}" alt="Work 2" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-4.jpg') }}" alt="Work 4" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-6.jpg') }}" alt="Work 6" /></a>
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work">
                    <div class="image">
                        <a href="#"><img src="{{ asset('assets/img/work-8.jpg') }}" alt="Work 8" /></a>
                    </div>
                    <div class="desc">
