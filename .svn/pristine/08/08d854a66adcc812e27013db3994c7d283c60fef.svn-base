    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.access.group.update', $group->id) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="title" name="title" value="{{ $group->title }}" placeholder="名称" data-parsley-trigger="change" data-parsley-required="true" data-parsley-maxlength="240" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a href="{{ route('backend.access.group.index') }}" class="btn btn-white">返回</a>
                        </div>
                    </div>
                </form>
            </div>
