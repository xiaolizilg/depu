    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">编辑保姆</h4>
            </div>
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.nanny.update', [$hospital->id, $nanny->id]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    <legend><h3 class="text-center">保姆信息</h3></legend>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">头像 :</label>
                        <div class="col-md-6 col-sm-6">
                            <div id="avatar_box" class="m-b-10" style="width:200px">
                                <div class="profile-image">
                                    <img class="m-auto" src="{{ get_image($nanny->avatar_id) }}" title="{{ get_image($nanny->avatar_id) }}" height="100%" />
                                </div>
                            </div>
                            <input class="form-control" type="text" name="avatar_id" id="avatar_id" value="{{$nanny->avatar_id}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">姓名 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="real_name" data-parsley-trigger="change" data-parsley-maxlength="80" data-parsley-required="true" placeholder="姓名" value="{{$nanny->real_name}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            @foreach($countries as $country)
                                <option value="{{ $country->id }}" {{ $country->id == $nanny->country_id ? 'selected' : '' }}>{{ $country->title }}</option>
                            @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sex" value="0" {{ 0 == $nanny->sex ? 'checked' : '' }}/> 女
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sex" value="1" {{ 1 == $nanny->sex ? 'checked' : '' }}/> 男
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" data-parsley-required="true" type="text" name="mobile" data-parsley-trigger="change" data-parsley-type="mobile" placeholder="联系电话" value="{{$nanny->mobile}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">费用 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="price" data-parsley-trigger="change" data-parsley-required="true" data-parsley-pattern="\d{0,8}\.\d{2}" placeholder="费用" value="{{$nanny->price}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">描述 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="desc" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="描述" value="{{$nanny->desc}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">简介 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="info" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="简介" value="{{$nanny->info}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">服务项目 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="service_content" data-parsley-trigger="change" data-parsley-maxlength="300" placeholder="服务项目" value="{{$nanny->service_content}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a href="{{ route('backend.hospital.nanny.index', $hospital->id) }}" class="btn btn-white">返回</a>
                        </div>
                    </div>
                </form>
            </div>
