    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.hotal.image.store', [$hospital, $hotal]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a href="{{ route('backend.hospital.hotal.image.index', [$hospital, $hotal]) }}" class="btn btn-white">返回</a>
                        </div>
                    </div>
                </form>
            </div>
