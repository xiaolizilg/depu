    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.account.admin.update', $admin->id) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div id="avatar_box" class="m-b-10" style="width:200px">
                                <div class="profile-image">
                                    <img class="m-auto" src="{{ get_image($admin->avatar_id) }}" title="{{ get_image($admin->avatar_id) }}" height="100%" />
                                    <i class="fa fa-user hide"></i>
                                </div>
                            </div>
                            <input class="form-control" type="text" name="avatar_id" id="avatar_id" value="{{$admin->avatar_id}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">昵称 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="nickname" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="昵称" value="{{$admin->name}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">真实姓名 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="real_name" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="真实姓名" value="{{$admin->info->real_name}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">联系方式 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="mobile" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="联系方式" value="{{$admin->info->mobile}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sex" value="0" {{ 0 == $admin->info->sex ? 'checked' : '' }}/> 女
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sex" value="1" {{ 1 == $admin->info->sex ? 'checked' : '' }}/> 男
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="input-group date">
                                <input type="text" name="birthday" class="form-control" value="{{$admin->info->birthday}}" placeholder="年-月-日" />
