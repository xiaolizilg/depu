    ...
    <div class="col-md-12">
        <div class="panel panel-inverse" data-sortable-id="form-validation">
            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.content.ad.store') }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="url" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="跳转地址" data-parsley-required="true" data-parsley-type="url" />
                        </div>
                    </div>
                    <div class="form-group">
